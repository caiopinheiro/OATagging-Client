...
//	}
	...
	public function rules()
	{
		...
		return array(
			array('email_user, nome, senha, confirmar_senha, faixa_etaria, nivel_esc, conhec_area, tipo_user, validacao', 'required'),
			array('email_user', 'length', 'max'=>50),
			array('nome', 'length', 'max'=>100),
			array('senha, confirmar_senha', 'required', 'on'=>'insert'),
                        array('senha, confirmar_senha', 'length', 'min'=>6, 'max'=>30),
                        array('senha', 'compare', 'compareAttribute'=>'confirmar_senha'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('email_user, nome, faixa_etaria, nivel_esc, conhec_area, tipo_user', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'nivel_esc' => 'Nivel de Escolaridade',
			'conhec_area' => 'Conhecimento da Área',
		);
	}
